...
class CertificacionController extends Controller
{
    ...
    public function indexAction()
    {
		...
		// Validad linealidad en programa de orientaci�n
    ...
    private function generarCertificado($usuario_id, $nombre_usuario)
    {
		...
		/**
		 * Creaci�n del nombre del usuario a certificarse
		 * 
		 * @var $nombre_usuario = Texto 1 a agregar a la imagen (Nombre del usuario) - Ingresado por parametro
		 * @var $font_size = Tama�o del texto a agregar
		 * @var $bbox = imagettfbbox retorna tama�o del contenedor (Caja circundante) del texto a agregar teniendo en cuenta tama�o, fuente, y texto
		 ...
		 * imagettftext incluye el texto en las cordenadas especificadas, tama�o, color (imagecolorallocate), fuente.
		 */
		$font_size = 30;
		...
		/**
		 * Creaci�n de la fecha de expedici�n del ceritificado
		 */
