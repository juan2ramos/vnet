...
INSERT INTO `permisos` (`id`,`identificador`,`nombre`,`descripcion`,`permiso_routes`) VALUES (6,'acceso_agenda_mentor','Acceso a la agenda de mentor','Acceso a la agenda de mentorias para mentores','agenda_mentor,show_mentoria_mentor,delete_mentoria_mentor,finalizar_mentoria_mentor,agenda_mentor_items,agenda_mentor_crear');
...
INSERT INTO `permisos` (`id`,`identificador`,`nombre`,`descripcion`,`permiso_routes`) VALUES (13,'acceso_mentor_ov','Acceso de administracion por parte del mentor OV','Acceso de administracion por parte del mentor de Orientación Vocacional','lista_usuarios_mentor,pruebas_usuarios_mentor,alternativas_estudio_estudiante,estado_mentorias_estudiante,upload_reporte_prueba,aprobar_prueba,generar_certificado');
...
INSERT INTO `permisos` (`id`,`identificador`,`nombre`,`descripcion`,`permiso_routes`) VALUES (32,'acceso_mercado_laboral','Acceso a mercado laboral','Acceso a mercado laboral','mercado_laboral');
...
INSERT INTO `permisos_roles` (`id`,`permiso_id`,`rol_id`) VALUES (null,32,5);
INSERT INTO `permisos_roles` (`id`,`permiso_id`,`rol_id`) VALUES (null,32,1);
...
-- PRODUCTOS
INSERT INTO `productos` (`id`, `nombre`, `descripcion`, `valor`) VALUES ('1', 'Programa de orientación', 'Programa completo para la toma de una decisión consciente', '850000');
INSERT INTO `productos` (`id`, `nombre`, `descripcion`, `valor`) VALUES ('2', 'Informe de mercado laboral', 'Acceso individual al informe de mercado laboral', '30000');
