...
CREATE SCHEMA IF NOT EXISTS `vocationet` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
SHOW WARNINGS;
USE `vocationet` ;
...
-- -----------------------------------------------------
-- Table `colegios_perfiles`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `colegios_perfiles` (
  `id` INT NOT NULL AUTO_INCREMENT ,
